...
contract CloakEscrowFactory is Ownable, Pausable {
    ...
    ) external onlyOwner whenNotPaused returns (address escrowAddress) {
     ...
     */
    function getEscrowsForMerchant(bytes32 merchantId) 
        external 
        view 
     ...
     */
    function getMerchantForEscrow(address escrowAddress) 
        external 
        view 
     ...
     */
    function getMerchantEscrowCount(bytes32 merchantId) 
        external 
        view 
     ...
     */
    function getMerchantCounter(bytes32 merchantId) 
        external 
        view 
     ...
     */
    function merchantExists(bytes32 merchantId) 
        external 
        view 
        returns (bool exists) 
    {
