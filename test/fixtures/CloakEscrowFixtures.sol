...
contract CloakEscrowFixtures is Test {
    ...
    function createEscrowFixture(TokenConfig memory config) public returns (EscrowFixture memory fixture) {
        ...
        fixture.escrow = new CloakEscrow(MERCHANT, address(fixture.token), PLATFORM, OWNER);
     ...
     */
    function createMultiTokenFixtures()
        public
        returns (EscrowFixture memory usdcFixture, EscrowFixture memory daiFixture, EscrowFixture memory wbtcFixture)
    {
     ...
     */
    function createCustomTokenConfig(string memory name, string memory symbol, uint8 decimals, uint256 mintAmount)
        public
        pure
